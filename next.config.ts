...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/visibility", destination: "/products", permanent: false },
      { source: "/visibility/:path*", destination: "/products", permanent: false },
      { source: "/sites", destination: "/products", permanent: false },
      { source: "/sites/:path*", destination: "/products", permanent: false },
